...
const { uploadImage, optimizeImage, autoCropImage } = require('../utils/cloudinary'); //
...
async function Upload(req, res) {
    try {
        ...
        res.json({ message: 'File uploaded successfully', url: result.secure_url , public_id: public_id});
      } catch (error) {
